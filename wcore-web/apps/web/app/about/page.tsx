      ...
      <div className="grid gap-6 lg:grid-cols-2 text-sm leading-relaxed">
        ...
        <section>
          ...
          <div className="grid gap-2 sm:grid-cols-2">
            ...
            <div className="flex gap-2"><span className="text-accent">🔁</span><span className="text-muted text-xs"><strong className="text-fg">Snapshot cache</strong>. Each scan result is versioned in Redis (scan:v2). A force-refresh skips the cache and rebuilds from the live chain.</span></div>
