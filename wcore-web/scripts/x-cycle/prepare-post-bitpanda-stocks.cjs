...
const IMAGE = resolve(ROOT, "apps/web/public/wcore-post-bitpanda-stocks.png");
const TEXT = [
  "Your stocks and crypto. One value.",
  "Bitpanda shares (NVDA, AAPL, GOOGL, TSLA and more) now sit next to your crypto in one clean portfolio view.",
  "Real brand logos. Provider-first pricing. Read only.",
  "Most trackers ignore your stocks. WCORE counts them.",
