...
## Corpus Check
- 341 files · ~366,305 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4321 nodes · 5742 edges · 306 communities (286 shown, 20 thin omitted)
...
Cohesion: 0.11
Nodes (46): DIAG_WEB_SCAN_LAST_ERROR(), DIAG_WEB_SCAN_STATUS(), LIVE_PROBE_WEB_SCAN_CHAIN(), _webScanAcquireAdmission_(), _webScanAcquireAdmissionV2_(), _webScanAllowed_(), _webScanAssetFromNative_(), _webScanAssetFromToken_() (+38 more)
