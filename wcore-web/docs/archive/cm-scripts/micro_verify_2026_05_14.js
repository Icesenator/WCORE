...
const checks = [
  { url: 'https://x.com/GARL_DEFI/status/2054444036249759752', marker: 'Hard mode is accurate' },
  { url: 'https://x.com/Mary__h0/status/2054625211345981741', marker: 'The hardest part is the memory load' },
];
