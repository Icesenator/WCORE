...
http.get('http://127.0.0.1:9222/json', res => {
  ...
  res.on('end', () => {
    ...
    async function main() {
      ...
      const tid = '2053897449803264390';
      const msg = "Thanks! Appreciate that. Feel free to check out the full dashboard at @wcorexyz and let me know what you think. Always open to feedback.";
