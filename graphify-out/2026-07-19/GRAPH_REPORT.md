# Graph Report - graphify-input  (2026-07-19)

## Corpus Check
- 341 files · ~364,659 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4307 nodes · 5704 edges · 305 communities (284 shown, 21 thin omitted)
...
1. `_webScanWallet_()` - 21 edges
2. `_wd_collectGlobalRefreshActions_()` - 20 edges
...
Cohesion: 0.08
Nodes (67): DIAG_RUN_WATCHDOG_SHEETS_API_FALLBACK(), DIAG_WATCHDOG_PARTIAL_CYCLES(), FORCE_RESCAN_LEDGERS(), FORCE_WATCHDOG_PARTIAL_CHECK(), INSTALL_QUOTA_RECOVERY(), MASTER_ON_EDIT(), PORTFOLIO_RECOVERY_REFRESH(), QUOTA_RECOVERY_SWEEP() (+59 more)
...
Cohesion: 0.07
Nodes (36): consider(), DIAG_BASE_ONCHAIN_V3(), DIAG_CMC_DEX_BASE_MISSING(), DIAG_CMC_DEX_TOKEN_BASE(), _dispatchGlobal(), _fetchJson(), _flushChunk(), _l1Key() (+28 more)

### Community 5 - "03E_QUOTA_CIRCUIT_BREAKER.js"
Cohesion: 0.06
Nodes (19): _autoMode(), _category(), checkQuotaAndReturnCache(), _claimAutomaticProbeLease(), _currentTrigger(), _getEffectiveMode(), _getManualMode(), _getTodayUTC() (+11 more)

### Community 6 - "41_GSHEET_WEB_SCAN.js"
Cohesion: 0.11
Nodes (43): DIAG_WEB_SCAN_LAST_ERROR(), DIAG_WEB_SCAN_STATUS(), LIVE_PROBE_WEB_SCAN_CHAIN(), _webScanAcquireAdmission_(), _webScanAllowed_(), _webScanAssetFromNative_(), _webScanAssetFromToken_(), _webScanAssetKey_() (+35 more)

### Community 7 - "gsheet.ts"
Cohesion: 0.09
Nodes (44): token(), applyDeFiPositionMirrorsToWalletAssets(), applyStakedPriceMirrors(), DefaultChainbaseData, defaultChainbaseProvider(), defaultPriceBatcher(), defaultScanRunner(), getOptimismRpcEndpoints() (+36 more)
...
Cohesion: 0.10
Nodes (14): TEST_ACCOUNT, app, circuitBreakers, getCircuitBreaker(), getScanLimit(), getUserPlan(), validateCustomToken(), PLAN_LIMITS (+6 more)

### Community 10 - "scan-utils.ts"
Cohesion: 0.19
Nodes (14): BalanceCacheEntry, BYPASS_PREFIXES, errorMessage(), getBalanceCacheKey(), getEngineCacheForScan(), hasCachedValue(), hasMajorPriceableTokenWithoutPrice(), isRetriableNonEvmResult() (+6 more)
...
Cohesion: 0.16
Nodes (19): StockFxQuoteMap, StockNativeQuoteMap, lastGood(), CanonicalStockService, CanonicalStockServiceDeps, distinctFxCurrencies(), isCompleteSnapshot(), isNonemptyString() (+11 more)

### Community 16 - "index.ts"
Cohesion: 0.11
Nodes (25): RFC-1918, registerCreatorRoutes(), checkStreakBadges(), CREATOR_BALANCE_SELECTOR, extractDeployedContractAddresses(), gamificationPlugin(), getChainRpc(), getChainRpcs() (+17 more)

### Community 17 - "schemas.ts"
Cohesion: 0.12
Nodes (27): registerGmContractsRoutes(), registerNotificationRoutes(), adminPlugin(), AdminPluginDeps, walletPlugin(), WalletPluginDeps, AdminEventsQuerySchema, AnyWalletAddress (+19 more)
...
Cohesion: 0.09
Nodes (12): BITPANDA_REFRESH_WATCHDOG(), BP_REINSTALL_CEX_TRIGGERS(), _bpEnsureCexTriggers_(), _bpGetRefreshFlag_(), _bpSheetHasRequest_(), CEX_HAS_MANUAL_REQUEST(), CEX_MANUAL_REFRESH_WORKER(), CEX_MANUAL_REFRESH_WORKER_FORCE() (+4 more)
...
Cohesion: 0.21
Nodes (17): WCORE_AUTO_HEAL(), WCORE_AUTO_HEAL_FORCE(), WCORE_AUTO_HEAL_STATUS(), WCORE_AUTO_HEAL_TIMER(), WCORE_TRIGGER_REINSTALL_FORCE_ONLY(), _wcoreAutoHealBootstrapState_(), _wcoreAutoHealCexStatus_(), _wcoreAutoHealCountHandlers_() (+9 more)
...
### Community 44 - "server-helpers.ts"
Cohesion: 0.19
...
Cohesion: 0.20
Nodes (13): DIAG_OKX_API(), DIAG_OKX_RELAY_CONFIG(), OKX_ON_EDIT(), OKX_REFRESH_WATCHDOG(), _okxBuildValues_(), _okxCanonicalSymbol_(), _okxFetchBucketsViaRelay_(), _okxGetRelay_() (+5 more)

### Community 149 - "dependencies"
Cohesion: 0.12
Nodes (17): bs58, @cosmjs/amino, @cosmjs/crypto, @cosmjs/encoding, @fastify/compress, jsonwebtoken, @noble/hashes, @wcore/db (+9 more)
...
Cohesion: 0.22
Nodes (11): _cbBuildValues_(), _cbFetchBucketsViaRelay_(), _cbGetRelay_(), _cbParseAmount_(), _cbSetRefreshFlag_(), _cbSetStatus_(), _cbWriteSheet_(), COINBASE_ON_EDIT() (+3 more)

### Community 158 - "gm-streak-rebuild.ts"
Cohesion: 0.17
Nodes (12): CHAIN_STEP_SIZES, fetchAllUserGmLogs(), GmLog, rebuildChainStreakFromOnchain(), RebuildDeps, RebuildEvent, RebuildResult, makeGmLog() (+4 more)

### Community 159 - "14_SVM_ENGINE.js"
Cohesion: 0.29
Nodes (11): learn(), _load(), _mg(), _ph(), _pn(), resolve(), _save(), _svmHex() (+3 more)
...
Cohesion: 0.19
Nodes (15): ApiConfig, ApiEnv, DEV_ENVS, getApiConfig(), parseRedisConfig(), parseTrustProxy(), readBoolean(), readCsv() (+7 more)
...
Cohesion: 0.11
Nodes (18): createGmHelpers(), GmHelpersDeps, getStatusOnchainCache(), registerGmOnchainRoutes(), setStatusOnchainCache(), MockUser, registerRoutes(), statusOnchainCache (+10 more)

### Community 173 - "scan-plugin-routes.test.ts"
Cohesion: 0.18
...
### Community 175 - "top-market-cap.ts"
Cohesion: 0.23
...
Cohesion: 0.20
Nodes (9): src/**/*, ../../tsconfig.base.json, compilerOptions, outDir, rootDir, useUnknownInCatchVariables, verbatimModuleSyntax, extends (+1 more)

### Community 185 - "scan.ts"
Cohesion: 0.26
Nodes (12): fetchFxRate(), hasUnfinalizedDeFiAssets(), ScanJob, scanJobs, startJobCleanup(), resolveScanChainLimit(), scanPlugin(), calcCleanChainValue() (+4 more)
...
Cohesion: 0.18
Nodes (12): _bpWriteRows_(), _cexBuildVerifFormula_(), _cexComputeAndAppendTotal_(), _cexFetchWebPrices_(), _cexGetPriceMap_(), _cexGetWebApiToken_(), _cexGetWebApiUrl_(), _cexRepairSheetStructure_() (+4 more)

### Community 188 - "44_CEX_BULK.js"
Cohesion: 0.39
Nodes (7): _cexBulkCanonicalSymbol_(), _cexBulkFetchAll_(), _cexBulkGetRelayToken_(), _cexBulkGetRelayUrl_(), _cexBulkMergeRows_(), _cexBulkWriteOne_(), UPDATE_CEX_RELAY_ALL()
...
Cohesion: 0.25
Nodes (10): isAdminAuthorized(), safeEq(), chainsPlugin(), ChainsPluginDeps, NativePriceQuerySchema, SupportTicketCreateBodySchema, SupportTicketUpdateBodySchema, TicketIdParamsSchema (+2 more)
...
- **Why does `registerGmOnchainRoutes()` connect `gm-onchain.ts` to `index.ts`, `schemas.ts`, `gm-streak-rebuild.ts`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
- **Why does `CanonicalCryptoService` connect `crypto-listing-service.ts` to `server.ts`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
- **Why does `registerGmContractsRoutes()` connect `schemas.ts` to `index.ts`, `gm-contracts.ts`, `gm-onchain.ts`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
