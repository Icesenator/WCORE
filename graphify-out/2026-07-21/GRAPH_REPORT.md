# Graph Report - graphify-input  (2026-07-21)

## Corpus Check
- 341 files · ~366,203 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4320 nodes · 5739 edges · 305 communities (285 shown, 20 thin omitted)
...
### Community 0 - "cex.ts"
Cohesion: 0.06
Nodes (72): BITFINEX_STABLE_MAP, BITFINEX_SYMBOL_ALIASES, BitfinexBuckets, bitfinexCanonicalSymbol(), BitpandaBuckets, BybitBuckets, canonicalCexSymbol(), CexProvider (+64 more)
...
Cohesion: 0.11
Nodes (45): DIAG_WEB_SCAN_LAST_ERROR(), DIAG_WEB_SCAN_STATUS(), LIVE_PROBE_WEB_SCAN_CHAIN(), _webScanAcquireAdmission_(), _webScanAcquireAdmissionV2_(), _webScanAllowed_(), _webScanAssetFromNative_(), _webScanAssetFromToken_() (+37 more)
...
Cohesion: 0.09
Nodes (18): TEST_ACCOUNT, ApiConfig, seedGmContracts(), metricsPlugin(), MetricsPluginDeps, app, circuitBreakers, getCircuitBreaker() (+10 more)

### Community 10 - "scan-utils.ts"
Cohesion: 0.17
Nodes (15): BalanceCacheEntry, BYPASS_PREFIXES, errorMessage(), getBalanceCacheKey(), getEngineCacheForScan(), getScanResultCacheKey(), hasCachedValue(), hasMajorPriceableTokenWithoutPrice() (+7 more)
...
Cohesion: 0.10
Nodes (27): RFC-1918, registerCreatorRoutes(), checkStreakBadges(), CREATOR_BALANCE_SELECTOR, extractDeployedContractAddresses(), gamificationPlugin(), getChainRpc(), getChainRpcs() (+19 more)

### Community 17 - "schemas.ts"
Cohesion: 0.13
Nodes (26): adminPlugin(), AdminPluginDeps, walletPlugin(), WalletPluginDeps, AdminEventsQuerySchema, AnyWalletAddress, CexProviderSchema, ChainKey (+18 more)
...
Cohesion: 0.21
Nodes (13): GsheetStockPortfolioRow, GsheetStockPortfolioSnapshot, buildGsheetStockPortfolioSnapshot(), BuildGsheetStockPortfolioSnapshotInput, holdingForRankedRow(), NormalizedHolding, normalizeHoldings(), RANKED_HOLDING_ALIASES (+5 more)

### Community 34 - "gm-contracts.ts"
Cohesion: 0.16
Nodes (18): addressFromTopic(), DeployReceipt, DISABLED_GM_CONTRACTS, filterDisabledGmContracts(), filterUnusedGmContracts(), findVerifiedDeployedContract(), GmContractAddress, GmContractResponse (+10 more)
...
Cohesion: 0.21
Nodes (14): applyDeFiPositionMirrorsToWalletAssets(), fetchFxRate(), finalizeDeFiAssets(), hasUnfinalizedDeFiAssets(), ScanJob, scanJobs, startJobCleanup(), resolveScanChainLimit() (+6 more)
...
Cohesion: 0.12
Nodes (17): bs58, @cosmjs/crypto, @cosmjs/proto-signing, fastify, dependencies, bs58, @cosmjs/crypto, @cosmjs/proto-signing (+9 more)
...
Cohesion: 0.24
Nodes (10): fetchStockFxQuotesViaRelay(), fetchStockQuotesViaRelay(), normalizeStockCurrency(), normalizeStockFxCurrencies(), STOCK_FX_CURRENCIES, STOCK_QUOTE_CURRENCIES, StockFxQuote, StockPriceMap (+2 more)
...
Cohesion: 0.12
Nodes (16): createGmHelpers(), GmHelpersDeps, getStatusOnchainCache(), registerGmOnchainRoutes(), setStatusOnchainCache(), MockUser, registerRoutes(), statusOnchainCache (+8 more)
...
Cohesion: 0.60
Nodes (3): CryptoListingRow, toCryptoMarketCapRow(), toStockMarketCapRow()
...
- **Why does `cexPlugin()` connect `cex.ts` to `server.ts`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
- **Why does `scanPlugin()` connect `chainbase-staking.ts` to `server.ts`, `scan-utils.ts`, `scan-plugin-routes.test.ts`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
- **Why does `token()` connect `gsheet.ts` to `server.ts`, `auth.ts`, `index.ts`, `schemas.ts`, `wallet-hints.ts`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
