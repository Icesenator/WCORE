...
> **Historical/completed plan.** Kept for implementation history only; verify current auth behavior in code, `AGENTS.md`, and `docs/audits/AUDIT.md` before acting on any task here.
