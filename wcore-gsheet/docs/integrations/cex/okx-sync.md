...
- Manuel : `CEX - OKX!A1` -> queue `CEX_MANUAL_REFRESH_WORKER` -> `UPDATE_OKX_SPOT()`.
- Groupe : `Portefeuille Crypto!U2` inclut OKX.
- Auto : quatrieme tour de `UPDATE_CEX_RELAY_ROTATION` toutes les 15 minutes, soit environ une mise a jour par heure. Aucun trigger OKX individuel n'est canonique.
