...
- Groupe : `Portefeuille Crypto!U2` inclut Coinbase.
- Auto : troisieme tour de `UPDATE_CEX_RELAY_ROTATION` toutes les 15 minutes, soit environ une mise a jour par heure. Aucun trigger Coinbase individuel n'est canonique.
