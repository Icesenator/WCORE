...
- `docs/audits/AUDIT.md` — audit consolidé unique (findings + roadmap)
- `docs/superpowers/specs/CM-STRATEGY.md` — communication X historique/stratégie
- `docs/reference/rpc-harmonization-2026-06-03.md` — défense RPC 11 couches
- `docs/reference/wcore-gsheet-to-web-reconciliation-2026-06-03.md` — apps-script vs web

## 📞 Escalade

Si aucun fix ci-dessus ne résout :
1. Vérifier `pnpm typecheck` + `pnpm lint` + `pnpm test` pour isoler le scope
2. Lire `docs/audits/AUDIT.md` Section concernée
