...
function BUILD_RPC_LOOKUP() {
  ...
  if (chainNames.length === 0) {
    chainNames = [
      ...
      "CITREA","COSMOS_HUB","CRONOS","CYBER","DBK_CHAIN","DOMA","DUCKCHAIN",
      ...
      "OPENLEDGER","OPTIMISM","OSMOSIS","PLASMA","PLUME","POLYGON",
      "PULSECHAIN","RACE","REYA","RONIN",
      "ROOTSTOCK","SCROLL","SEI","SHAPE","SHIBARIUM","SOLANA","SOMNIA",
      "SONEIUM","SONIC","STABLE","STORY","SUPERPOSITION","SUPERSEED","SWAN",
      "SWELLCHAIN","TAC","TAIKO_ALETHIA","TERRA","UNICHAIN",
